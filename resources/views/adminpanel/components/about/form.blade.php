  ...
  @csrf
    ...
    <div class="row mt-4">
      <div class="col-12 col-md-6">
        <img src="{{ asset('/public/images/about_images/horizontal/'.$about[0]->horizontal_image) }}" class="img-fluid" alt="">
      </div>
    </div>
    @endif
    ...
    <div class="row mt-4">
      <div class="col-12 col-md-6">
        <img src="{{ asset('/public/images/about_images/vertical/'.$about[0]->vertical_image) }}" class="img-fluid" alt="">
      </div>
    </div>
    @endif
    <div class="form-group row mt-3">
