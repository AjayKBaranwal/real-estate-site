...
<div class="row">
  <div class="col-12 col-md-6">
    <img src="{{ asset('/public/images/testemonial_images/'.$testemonial->image_filename) }}" class="img-fluid" alt="">
  </div>
</div>
...
<div class="row">
  <div class="col-12 col-md-6">
    <img src="{{ asset('/public/images/testemonial_images/mini/'.$testemonial->mini_image_filename) }}" class="img-fluid" alt="">
  </div>
</div>
