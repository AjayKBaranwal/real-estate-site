        ...
        <div id="property-single-carousel" class="owl-carousel owl-arrow gallery-property">
          @foreach($property->images as $image)
            <div class="carousel-item-b">
              <img src="{{ asset('/public/images/property_images/horizontal_images/'.$image->filename) }}" alt="">
            </div>
          @endforeach
        </div>
      ...
      <div class="col-md-12">
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4">
            <img src="{{ asset('/public/images/agent_images/'.$property->agent->image) }}" alt="" class="img-fluid">
          </div>
          <div class="col-md-6 col-lg-4">
...
<div class="whatsup-icon">
  <a href="https://wa.me/+917022118160?text=Hi, enquiry for {{ $property->house_number }} {{ $property->street_name }}" target="_blank"><img src="/storage/whatsup-icon.png" alt="whatsup-logo" width="64px" height="64px"></a>
</div>
