        ...
        <div class="row">
          <div class="col-md-6">
            <div class="agent-avatar-box">
              <img src="{{ asset('/public/images/agent_images').'/'.$agent->image }}" alt="" class="agent-avatar img-fluid">
            </div>
          </div>
      ...
      >
        ...
        <div class="col-md-4">
          <div class="card-box-a card-shadow">
            <div class="img-box-a">
              <img src="{{ asset('/public/images/property_images/vertical_images/'.$property->vertical_image) }}" alt="" class="img-a img-fluid">
            </div>
